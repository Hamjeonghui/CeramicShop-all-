		...
		<div id="contentWrap" class="container">
			<div class="bor10 p-lr-70 p-t-55 p-b-70 p-lr-15-lg">
				...
				<form action="cinsert.do" method="post">
					<%-- 작성자 id 넘겨주기 --%>
					<input type="hidden" name="auid" value="${udata_s.uuid}">
					<h4 class="mtext-105 cl2 txt-left">게시글 등록</h4>
					...
					<table class="bor8 m-b-40">
						<tr>
							...
							<td><input
								...
								type="text" name="atitle" placeholder="제목 작성 (최대 300자)" required maxlength="300"></td>
						</tr>
						<tr>
							<th class="bor8">글 내용</th>
							<td><textarea
									class="stext-111 cl2 plh3 size-124 p-lr-18 p-tb-15"
									name="atext" required placeholder="내용 작성 (최대 1000자)" maxlength="1000"></textarea></td>
						</tr>
