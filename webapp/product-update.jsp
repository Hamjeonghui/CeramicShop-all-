		...
		<div id="contentWrap" class="container">
				<div class="bor10 p-lr-70 p-t-55 p-b-70 p-lr-15-lg">
					...
					<input type="hidden" name="pnum" value="${pdata.pnum}">
						...
						<p class="fs-11">아래의 버튼을 통해 수정 혹은 제품의 삭제가 가능합니다.</p>
						<hr class="m-b-60">
						...
						<table class="bor8 m-b-40">
							<tr>
								...
								maxlength="300"
								name="pname" value="${pdata.pname}" required></td>
							</tr>
							<tr>
								<th class="bor8">제품설명</th>
								<td><textarea class="stext-111 cl2 plh3 size-124 p-lr-18 p-tb-15"
									maxlength="1000"
									name="ptext" value="${pdata.ptext}" required>${pdata.ptext}</textarea></td>
							</tr>
							<tr>
								<%-- 숫자만 입력 가능 --%>
								<th class="bor8">제품가격</th>
								<td><input class="bor8  stext-111 cl2 plh3 size-116 p-l-18 p-r-30" type="text" name="pprice" value="${pdata.pprice}" 
								maxlength="7" required pattern="[0-9]+" title="*숫자만 입력 가능합니다.*"></td>
							</tr>
							<tr>
								<%-- 1이하 입력 불가능 --%>
								<th class="bor8">제품재고</th>
								<td><input class="bor8  stext-111 cl2 plh3 size-116 p-l-18 p-r-30" type="number" 
								max="100" min="1" oninput='handleOnInput(this,3)'
								name="pstock" value="${pdata.pstock}" required></td>
							</tr>
							<tr>
								<%-- 이미지의 업로드만을 허용 --%>
								<th class="bor8">제품이미지</th>
								<td><input class="bor8  stext-111 cl2 plh3 size-127 p-l-18 p-r-30" type="file"   name="image" accept="image/*"></td>
							</tr>
						</table>
						<input type="submit" class="flex-c-m stext-101 cl0 size-121 bg3 bor1 hov-btn3 p-lr-15 trans-04 pointer m-b-20" value="등록완료">
						<%-- 현재 조회중인 PK의 데이터 삭제 --%>
						<a id="deletebtn" href="pdelete.do?pnum=${pdata.pnum}" class="flex-c-m stext-101 cl0 size-121 bg3 bor1 hov-btn3 p-lr-15 trans-04 pointer">삭제하기</a>
					</form>
