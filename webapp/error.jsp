...
<body class="animsition">
	...
	<div id="wrapper">
		...
		<div class="bg-img1 p-lr-15 p-tb-92"
			style="background-image: url('https://365psd.com/images/previews/05e/404-error-page-free-psd-template-56927.jpg');">
		</div>

		<!-- Content page -->
		<section class="bg0 p-t-104 p-b-116">
			<div class="container" id="contentWrap">
				<div class="bor10 p-lr-70 p-t-55 p-b-70 p-lr-15-lg txt-center">

					<h2>관리자에게 문의 바랍니다.</h2>
					<p class="fs-7 m-b-30">관리자 연락처: 010-0000-0000</p>

					<p>예외 유형 : ${pageContext.errorData.throwable}</p>
					<p>발생 url : ${pageContext.errorData.requestURI}</p>
	...
	<script
		src="https://maps.googleapis.com/maps/api/js?key= 발급받은 api">
	</script>
